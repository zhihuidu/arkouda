...
def time_ak_bfs_graph(lgNv:int, Ne_per_v:int, p:float,directed:int,weighted:int):
    ...
    #Graph=ak.graph_file_read(786396,262144,2,directed,"/home/z/zd4/ArkoudaExtension/arkouda/data/delaunay/delaunay_n18.gr")
    #Graph=ak.rmat_gen(lgNv, Ne_per_v, p, directed, weighted)
    #Graph=ak.graph_file_read(103689,8276,2,directed,"/home/z/zd4/ArkoudaExtension/arkouda/data/graphs/wiki")
    #Graph=ak.graph_file_read(2981,2888,2,directed,"/home/z/zd4/ArkoudaExtension/bakarkouda/data/graphs/fb")
    #Graph=ak.graph_file_read(1000,1001,2,directed,"/home/z/zd4/ArkoudaExtension/arkouda/data/line.gr")
    ...
    Graph=ak.graph_file_read(100,29,2,directed,"/home/z/zd4/ArkoudaExtension/arkouda/data/25-4.gr")
    #Graph=ak.graph_file_read(10000,10001,2,directed,"/home/z/zd4/ArkoudaExtension/data/10000-1.gr")
    #Graph=ak.graph_file_read(100,101,2,directed,"/home/z/zd4/ArkoudaExtension/data/100-1.gr")
