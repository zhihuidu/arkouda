...
def time_ak_tri_graph(lgNv:int, Ne_per_v:int, p:float,directed:int,weighted:int):
    ...
    #Graph=ak.graph_file_read(3056,1025,2,directed,"data/delaunay_n10.gr")
    #Graph=ak.stream_file_read(3056,1025,2,directed,"data/delaunay_n10.gr",4)
    #triary=ak.stream_tri_cnt(3056,1025,2,directed,"data/delaunay_n10.gr",2)
    #Graph=ak.rmat_gen(lgNv, Ne_per_v, p, directed, weighted)
    #Graph=ak.stream_file_read(103689,8276,2,directed,"data/graphs/wiki")
    #Graph=ak.graph_file_read(2981,2888,2,directed,"data/graphs/fb")
    #Graph=ak.graph_file_read(3,3,2,directed,"data/1.gr")
    #Graph=ak.graph_file_read(6,4,2,directed,"data/2.gr")
    #Graph=ak.graph_file_read(1000,10001,2,directed,"data/line.gr")
    ...
    '''
    start = time.time()
    #triary=ak.stream_tri_cnt(3056,1025,2,directed,"data/delaunay_n10.gr",1)
    triary=ak.streamPL_tri_cnt(3056,1025,2,directed,"data/delaunay_n10.gr",8)
    #triary=ak.streamPL_tri_cnt(24,33,2,directed,"data/1.gr",1)
    end = time.time()
    print("----------------------")
